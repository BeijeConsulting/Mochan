...
class Auth extends Component {
    ...
    inputChangedHandler = (event, email) => {
        // if (this.state.currentStep === 2 && this.state.controlsTwo.password.validation.minLength === 1) {        ------->> è un controllo sulla lunghezza della stringa ma tanto quando compili il form non viene applicato alcun controllo su quello
        //     this.setState({
        //         controlsTwo: {
        //             password: {
        //                 validation: {
    ...
    //     this.setState({
    //         correctPassword: false        //se non lo commento mi viene fuori l'avviso in rosso se nn compilo l'email
    //     })
    // }
